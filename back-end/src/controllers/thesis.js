...
const thesisStartSchema = require('../schemas/ThesisStartSchema');
...
const getLoggedStudentThesis = async (req, res) => {
    try {
        ...
        const responsePayload = {
            ...
            thesis_conclusion_request_date: thesisData.thesis_conclusion_request_date ? thesisData.thesis_conclusion_request_date.toISOString() : null,
            thesis_conclusion_confirmation_date: thesisData.thesis_conclusion_confirmation_date ? thesisData.thesis_conclusion_confirmation_date.toISOString() : null,
        };
