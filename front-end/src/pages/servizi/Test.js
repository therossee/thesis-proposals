                            ...
                            <Card.Body>
                                <div className="mb-3">
                                    <strong>
                                        ...
                                        Studente:
                                    </strong> {application.student?.firstName} {application.student?.lastName}
                                    <br />
                                    <strong>
                                        <i className="fa-solid fa-chalkboard-user me-2" />
                                        Relatore:
                                    </strong> {application.supervisor?.firstName} {application.supervisor?.lastName}
                                    <br />
                                    <strong>
                                        <i className="fa-solid fa-calendar me-2" />
                                        Data presentazione:
                                    </strong> {new Date(application.submissionDate).toLocaleDateString('it-IT')}
                                </div>
