                ...
                <Col md={8}>
                    <Card className="mb-3 roundCard py-2">
                        ...
                        <Card.Body className="pt-2 pb-0">
                            ...
                            {thesis.conclusionConfirmationDate && (<CustomBlock icon="check-circle" title="carriera.tesi.date_conclusion_confirmation" ignoreMoreLines={true}>
                                {moment(thesis.conclusionConfirmationDate).format('DD/MM/YYYY - HH:mm')}
                            </CustomBlock>)}
                            {thesis.conclusionRequestDate && (<CustomBlock icon="check-circle" title="carriera.tesi.date_conclusion_requested" ignoreMoreLines={true}>
                    ...
                    <Row className="mb-3">
                        ...
                        <Col md={5}>
                            <Card className="mb-3 roundCard py-2">
                                ...
                                <Card.Body className="pt-2 pb-0">
                                    <LinkBlock icon="copyright" title="carriera.tesi.utilities.copyright" link="carriera.tesi.utilities.copyright_link" />
                                    <LinkBlock icon="file-lines" title="carriera.tesi.utilities.thesis_template" link="https://www.overleaf.com/latex/templates/politecnico-di-torino-thesis-template/cmpmxftwvvbr" />
                                    <LinkBlock icon="file-word" title="carriera.tesi.utilities.thesis_cover_word" link="carriera.tesi.utilities.thesis_cover_word_link" />
                                    <LinkBlock icon="file-image" title="carriera.tesi.utilities.logo" link="carriera.tesi.utilities.logo_link" />
                                    <LinkBlock icon="link" title="carriera.tesi.utilities.plagiarism" link="carriera.tesi.utilities.plagiarism_link" />
                                    {thesis.company && (
