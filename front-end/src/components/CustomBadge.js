    ...
    return (
      ...
      >
        {variant === 'abroad' ? (
          ...
          <svg
            style={{ borderRadius: '3px', width: '25px', height: '25px' }}
            ...
            viewBox="0 0 230 260"
            enableBackground="new 0 0 230 260"
            space="preserve"
          >
  ...
  const renderIcon = content => {
    switch (variant) {
      ...
      case 'italy':
        return (
          <svg
            style={{ borderRadius: '3px', width: '12px', height: '12px' }}
            className="icon-italy-badge"
            version="1.1"
            id="Layer_1"
            xmlns="http://www.w3.org/2000/svg"
            xlink="http://www.w3.org/1999/xlink"
