...
export default function ThesisApplicationForm({ proposalId }) {
  ...
  return (
    <div>
                    ...
                    <div className="d-flex flex-column mb-3">
                      <div className="d-flex align-items-start mb-2">
                        <p className="mb-0">
                          ...
                          {t('carriera.richiesta_tesi.step_1')}
                        </p>
                      </div>
                      <div className="d-flex align-items-start mb-2">
                        <p className="mb-0">
                          <i className="fa-solid fa-2 fa-sm pe-3 pt-1" />
                          {t('carriera.richiesta_tesi.step_2')}
                        </p>
                      </div>
                      <div className="d-flex align-items-start mb-2">
                        <p className="mb-0">
                          <i className="fa-solid fa-3 fa-sm pe-3 pt-1" />
                          {t('carriera.richiesta_tesi.step_3')}
                        </p>
                      </div>
                    </div>
      ...
      <FormModal show={showModal} handleClose={() => setShowModal(false)} sendApplication={handleSubmit} />
    </div>
  );
}
